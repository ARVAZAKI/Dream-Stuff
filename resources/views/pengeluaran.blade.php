...
<html lang="en">
  <head>
    ...
    <title>DreamStuff | tambah pengeluaran</title>
    ...
    <div class="row">
        <div class="col-lg-3 mt-5 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('pengeluaran', $stuff->kode_barang)}}" method="post">
                    @csrf
                    @method('put')
                    <label for="uang_masuk" class="form-label">Tambahkan uang</label>
                    <input type="number" class="form-control" name="uang_keluar" id="uang_keluar">
